...
const base64EncodeFile = require('../helper/base64EncodeFile').base64EncodeFile;
...
db.serialize(() => {
  ...
  const posters = [
    { game_id: 1, poster: fileToBlob(path.join(__dirname, 'seed_images', '1.png')) },
    { game_id: 2, poster: fileToBlob(path.join(__dirname, 'seed_images', '2.png') )},
    { game_id: 3, poster: fileToBlob(path.join(__dirname, 'seed_images', '3.png'))},
    { game_id: 4, poster: fileToBlob(path.join(__dirname, 'seed_images', '4.png')) }

  ];
console.log(typeof posters[0].poster);
